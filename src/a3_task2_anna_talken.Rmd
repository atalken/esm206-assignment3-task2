...
mpg_make_model <- mpg %>% # Start with mpg
  unite(col = make_model, # Create a new column called 'make_model'
        ...
        sep = "___" # Puts "HEY!" between the pieces (default is underscore)
        ) 
...
some_dates_converted <- lubridate::mdy(some_dates)
...
gasol_hook_number <- gasol_hookshots %>% 
  count(month)
```
